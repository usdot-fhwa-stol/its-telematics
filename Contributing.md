# ITS Telematics - Collaboration Opportunities

Developed on a publisher-subscriber, cloud based architecture, ITS Telematics provides a platform to stream large volume of big data, generated by various CARMA products - CARMA platform (vehicles and Messenger), CARMA Streets, CARMA Cloud and V2X Hub.
On the front-end of this system, is a web-based UI client and a visualization dashboard, where a user can visualize and analyze the data from different CARMA systems, in near-real-time environment.

# How to Contribute

Welcome to the ITS Telematics contributing guide. There are a few guidelines that we need contributors to follow so that we can have a chance of keeping on top of things.
...
## The End
Hope this guide helps you get started in contributing to the ITS Telematics project!
