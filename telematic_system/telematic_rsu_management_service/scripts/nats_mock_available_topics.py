...
SUBJECT_PATTERN = "unit.*.data.selection.available.topics"
NATS_URL = os.getenv("NATS_URL", "nats://127.0.0.1:4222")

# Example payload structure matching TRUTopicsMessage/RSUTopicsMessage/TopicMessage
# {
#   "unitId": "123",
#   "rsuTopics": [
#     {
#       "rsuEndpoint": {"IP": "10.0.0.1", "Port": 8080},
#       "topics": [
#         {"name": "topicA", "selected": false},
#         {"name": "topicB", "selected": true}
#       ]
#     }
#   ]
# }
